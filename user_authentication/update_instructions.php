...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        if (isset($_SESSION['u_id'])) {
            ...
            echo $username;
            echo $orderId;
            $query = "SELECT * FROM `bookingOrderSlot` WHERE orderID='$orderId'";
        ...
        ?>
                <tr>
                    ...
                    <td> <form action="update_instruction_delivery.php"> Instructions:<input type="text" name="deliveryInstructions" value="<?php echo $row['deliveryInstructions'] ?>" placeholder="Update Instructions" Required>
  <br><input type="hidden" name="orderId" value="<?php echo $row['orderID'] ?>" />
