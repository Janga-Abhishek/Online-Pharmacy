...
<div class="container">
    ...
    if (isset($_SESSION['u_id']) && isset($_SESSION['id'])) {
        ...
        if (isset($_POST["insert1"])) {
            ...
            $id = $_GET['id'];
            $query1 = mysqli_query($con, "select * from prescription where id='$id'");
            $data = mysqli_fetch_array($query1);

            $query = "INSERT INTO bookingSlot VALUES('$id','Pick Up at Store')";
            if (mysqli_query($con, $query)) {
                $query2 = mysqli_query($con, "update prescription set Order_Status='Pick Up at Store' where id='$id'");
    ...
    <br>
    <a class="delievry_option slot_book1" href="calanderPrescription.php?id=<?php $id = $_GET['id'];
