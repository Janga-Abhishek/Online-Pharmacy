...
<body>
	...
	<div align="center" class="mt-5 abc" style="padding-top: 50px;">
		<a href="user_prescription_ready.php"><button class="btn btn-lg btn-primary">PRESCRIPTIONS</button></a><br><br>
		<a href="user_orders_ready.php"><button class="btn btn-lg btn-primary">ORDER DETAIL</button></a><br><br>
	</div>
